...
export function Header() {
  ...
  return (
    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#F2EDE0]/80 backdrop-blur-sm border-b-2 border-border h-14">
        ...
        <div className="flex items-center justify-between h-14">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <span className="font-semibold text-sm sm:text-base">Evolve-ed </span>
            </Link>
          </div>
            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger asChild>
                  <Link
                    href="https://github.com/Vikram2410rawal"
                    target="_blank"
